...
class TemplateCtrl {
     ...
     */
    public function template_list( $post_templates, $wp_theme, $post, $post_type ) {
     ...
     * @since 1.0.0
     */
    public function template_path( $default ) {
        $templates = [ 'workspace', 'invoice', 'estimate', 'package', 'form' ];
