 ...
 * I18n class.
 *
 * Responsible for managing all translation data for react app
 *
 * @since 1.0.0
 */
class I18n {
    ...
    public static function dashboard() {
        return [
            ...
            'template' => esc_html__( 'Template', 'propovoice' ),
            'selectTmpl' => esc_html__( 'Select Template', 'propovoice' ),
            ...
            'recurPeriod' => esc_html__( 'Recurring Period', 'propovoice' ),
            'onetime' => esc_html__( 'Onetime', 'propovoice' ),
            ...
            'packageDetails' => esc_html__( 'Package Details', 'propovoice' ),
            'packagePricing' => esc_html__( 'Package Pricing', 'propovoice' ),
            ...
            'prvShare' => __( 'Preview & Share', 'propovoice' ),
            ...
            'edit_comment' => esc_html__( 'Edit Comment', 'propovoice' ),
            ...
            'edit_msg' => esc_html__( 'Edit Message', 'propovoice' ),
            ...
            'publish' => esc_html__( 'Publish', 'propovoice' ),
            ...
            'buy' => esc_html__( 'Buy', 'propovoice' ),
            'buyWith' => esc_html__( 'Buy With', 'propovoice' ),
            'buyNow' => esc_html__( 'Buy Now', 'propovoice' ),
            ...
            'paymentMethod' => esc_html__( 'Payment Method', 'propovoice' ),
            ...
            'paidDes' => esc_html__( 'Thanks, We have received your payment', 'propovoice' ),
            ...
            'movedToProject' => esc_html__( 'Moved to Project', 'propovoice' ),
            ...
            // Translators: %1$s is the name of the missing resource (e.g., course, file), %2$s is the type of resource (e.g., courses, files)
            'noResClient' => esc_html__(
                'Sorry! There is no available %1$s %2$s',
                'propovoice'
            ),
            ...
            'notAdd' => esc_html__( 'You have not %1$s any %2$s yet.', 'propovoice' ),
            ...
            'csvDco' => esc_html__( 'Please make sure your csv file has unique headers. Otherwise, it may fail to import', 'propovoice' ),
            // custom field
