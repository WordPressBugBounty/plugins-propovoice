...
class Package {
    ...
    public function get_single( $req ) {
        ...
        if ( $id ) {
            ...
            $package['token'] = isset( $package_meta['token'] ) ? $package_meta['token'][0] : '';
            $package['currency'] = isset( $package_meta['currency'] ) ? $package_meta['currency'][0] : '';
            $package['total'] = isset( $package_meta['price'] ) ? $package_meta['price'][0] : '';
            $package['price'] = isset( $package_meta['price'] ) ? $package_meta['price'][0] : '';
            $package['max_req'] = isset( $package_meta['max_req'] ) ? $package_meta['max_req'][0] : '';
            $package['max_req_at_a_time'] = isset( $package_meta['max_req_at_a_time'] ) ? $package_meta['max_req_at_a_time'][0] : '';

            $package['is_reminder'] = isset( $package_meta['is_reminder'] ) ? $package_meta['is_reminder'][0] : false;
            $reminder = isset( $package_meta['reminder'] )
                ? $package_meta['reminder']
                : null;
            if ( ! $reminder ) {
                $reminder_data = [];
                ...
                $package['reminder'] = $reminder_data;
            }

            $package['is_recurring'] = isset( $package_meta['is_recurring'] ) ? $package_meta['is_recurring'][0] : false;
            $package['recurring'] = isset( $package_meta['recurring'] )
            ...
            if ( ! $package['recurring'] && ! isset( $param['client_view'] ) ) {
                ...
                $package['recurring'] = $recurring_data;
            }
