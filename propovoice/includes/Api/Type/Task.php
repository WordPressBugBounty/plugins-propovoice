...
class Task {
    ...
    public function routes() {
        ...
        register_rest_route(
            'ndpv/v1', '/tasks' . ndpv()->plain_route(), [
				'methods' => 'GET',
				'callback' => [ $this, 'get' ],
				'permission_callback' => [ $this, 'get_per' ],
			]
        ...
        while ( $query->have_posts() ) {
            ...
            if ( $dashboard ) {
                ...
                if ( $start_date ) {
                    ...
                    $format_start_date = gmdate( 'Y-m-d', strtotime( $start_date ) );
    ...
    public function create( $req ) {
        ...
        if ( $reg_errors->get_error_messages() ) {
            ...
            if ( ! is_wp_error( $post_id ) ) {
                ...
                $param['id'] = $post_id;
                do_action( 'ndpvp_webhook', 'task_add', $param );
    ...
    public function update( $req ) {
        ...
        $due_date = isset( $param['due_date'] ) ? $param['due_date'] : null;
        $checklist = isset( $param['checklist'] ) ? $param['checklist'] : [];
        ...
        if ( $reg_errors->get_error_messages() ) {
            ...
            if ( ! is_wp_error( $post_id ) ) {
                ...
                do_action( 'ndpvp_webhook', 'task_edit', $param );
    ...
    public function delete( $req ) {
        ...
        do_action( 'ndpvp_webhook', 'task_del', $ids );
